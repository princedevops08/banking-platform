// Command admin-service manages platform-wide feature flags and settings.
package main
...
import (
	...
	"banking-platform/services/admin-service/internal/config"
	"banking-platform/services/admin-service/internal/handler"
	"banking-platform/services/admin-service/internal/repository"
	"banking-platform/services/admin-service/internal/service"
	"banking-platform/services/admin-service/migrations"
)
...
func run() error {
	...
	log.Info("admin-service started", zap.Int("http_port", cfg.HTTP.Port))
