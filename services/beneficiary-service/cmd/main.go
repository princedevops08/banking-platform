// Command beneficiary-service manages customers' saved payees.
package main
...
import (
	...
	"banking-platform/services/beneficiary-service/internal/config"
	"banking-platform/services/beneficiary-service/internal/handler"
	...
	"banking-platform/services/beneficiary-service/migrations"
)
...
func run() error {
	...
	log.Info("beneficiary-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("beneficiary-service stopped cleanly")
	return nil
}
