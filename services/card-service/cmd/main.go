// Command card-service manages customers' payment cards.
package main
...
import (
	...
	"banking-platform/services/card-service/internal/config"
	"banking-platform/services/card-service/internal/handler"
	"banking-platform/services/card-service/internal/repository"
	"banking-platform/services/card-service/internal/service"
	"banking-platform/services/card-service/migrations"
)
...
func run() error {
	...
	log.Info("card-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("card-service stopped cleanly")
	return nil
}
