// Command currency-exchange-service serves FX rates and currency conversion.
package main
...
import (
	...
	"banking-platform/services/currency-exchange-service/internal/config"
	"banking-platform/services/currency-exchange-service/internal/handler"
	...
	"banking-platform/services/currency-exchange-service/migrations"
)
...
func run() error {
	...
	log.Info("currency-exchange-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("currency-exchange-service stopped cleanly")
	return nil
}
