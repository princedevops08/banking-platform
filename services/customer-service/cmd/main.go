// Command customer-service manages the customer master record.
package main
...
import (
	...
	"banking-platform/services/customer-service/internal/config"
	"banking-platform/services/customer-service/internal/handler"
	...
	"banking-platform/services/customer-service/migrations"
)
...
func run() error {
	...
	log.Info("customer-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("customer-service stopped cleanly")
	return nil
}
