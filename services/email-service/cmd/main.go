// Command email-service is a mock email provider.
package main
...
import (
	...
	"banking-platform/services/email-service/internal/config"
	"banking-platform/services/email-service/internal/handler"
	"banking-platform/services/email-service/internal/repository"
	"banking-platform/services/email-service/internal/service"
	"banking-platform/services/email-service/migrations"
)
...
func run() error {
	...
	log.Info("email-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("email-service stopped cleanly")
	return nil
}
