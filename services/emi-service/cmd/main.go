// Command emi-service generates loan amortization schedules and tracks EMI
...
import (
	...
	"banking-platform/services/emi-service/internal/config"
	"banking-platform/services/emi-service/internal/handler"
	"banking-platform/services/emi-service/internal/repository"
	"banking-platform/services/emi-service/internal/service"
	"banking-platform/services/emi-service/migrations"
)
...
func run() error {
	...
	log.Info("emi-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("emi-service stopped cleanly")
	return nil
}
