// Command fixed-deposit-service manages customers' fixed deposits.
package main
...
import (
	...
	"banking-platform/services/fixed-deposit-service/internal/config"
	"banking-platform/services/fixed-deposit-service/internal/handler"
	...
	"banking-platform/services/fixed-deposit-service/migrations"
)
...
func run() error {
	...
	log.Info("fixed-deposit-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("fixed-deposit-service stopped cleanly")
	return nil
}
