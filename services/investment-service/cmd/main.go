// Command investment-service manages customers' investment holdings.
package main
...
import (
	...
	"banking-platform/services/investment-service/internal/config"
	"banking-platform/services/investment-service/internal/handler"
	...
	"banking-platform/services/investment-service/migrations"
)
...
func run() error {
	...
	log.Info("investment-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("investment-service stopped cleanly")
	return nil
}
