// Command kyc-service manages KYC submission and review workflow.
package main
...
import (
	...
	"banking-platform/services/kyc-service/internal/config"
	"banking-platform/services/kyc-service/internal/handler"
	"banking-platform/services/kyc-service/internal/repository"
	"banking-platform/services/kyc-service/internal/service"
	"banking-platform/services/kyc-service/migrations"
)
...
func run() error {
	...
	log.Info("kyc-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("kyc-service stopped cleanly")
	return nil
}
