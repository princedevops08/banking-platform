// Command profile-service manages customers' extended profile details.
package main
...
import (
	...
	"banking-platform/services/profile-service/internal/config"
	"banking-platform/services/profile-service/internal/handler"
	"banking-platform/services/profile-service/internal/repository"
	"banking-platform/services/profile-service/internal/service"
	"banking-platform/services/profile-service/migrations"
)
...
func run() error {
	...
	log.Info("profile-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("profile-service stopped cleanly")
	return nil
}
