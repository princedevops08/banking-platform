// Command recurring-deposit-service manages customers' recurring deposit plans.
package main
...
import (
	...
	"banking-platform/services/recurring-deposit-service/internal/config"
	"banking-platform/services/recurring-deposit-service/internal/handler"
	...
	"banking-platform/services/recurring-deposit-service/migrations"
)
...
func run() error {
	...
	log.Info("recurring-deposit-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("recurring-deposit-service stopped cleanly")
	return nil
}
