// Command reports-service consumes transaction events from Kafka and maintains
// per-day, per-currency aggregates, exposing a staff-only query API.
package main
...
import (
	...
	"banking-platform/services/reports-service/internal/config"
	"banking-platform/services/reports-service/internal/handler"
	"banking-platform/services/reports-service/internal/repository"
	"banking-platform/services/reports-service/internal/service"
	"banking-platform/services/reports-service/migrations"
)

// consumedTopics are the domain event streams reports-service aggregates.
...
func run() error {
	...
	log.Info("reports-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("reports-service stopped cleanly")
	return nil
}
