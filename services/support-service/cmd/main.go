// Command support-service manages customer support tickets.
package main
...
import (
	...
	"banking-platform/services/support-service/internal/config"
	"banking-platform/services/support-service/internal/handler"
	"banking-platform/services/support-service/internal/repository"
	"banking-platform/services/support-service/internal/service"
	"banking-platform/services/support-service/migrations"
)
...
func run() error {
	...
	log.Info("support-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("support-service stopped cleanly")
	return nil
}
