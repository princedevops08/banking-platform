// Package ledgerclient adapts the ledger gRPC client for transaction-service.
...
// Post applies a balanced transaction and reports whether it was a duplicate.
