// Command wallet-service manages customers' stored-value wallets.
package main
...
import (
	...
	"banking-platform/services/wallet-service/internal/config"
	"banking-platform/services/wallet-service/internal/handler"
	"banking-platform/services/wallet-service/internal/repository"
	"banking-platform/services/wallet-service/internal/service"
	"banking-platform/services/wallet-service/migrations"
)
...
func run() error {
	...
	svc := service.New(repo, cfg.ServiceName, emitEvents, log)
	...
	log.Info("wallet-service started", zap.Int("http_port", cfg.HTTP.Port))
	...
	log.Info("wallet-service stopped cleanly")
	return nil
}
